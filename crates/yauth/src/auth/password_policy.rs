...
const COMMON_PASSWORDS: &[&str] = &[
    ...
    "dallas", "austin", "thunder", "taylor", "matrix", "mobilemail", "admin",
    "passwd", "welcome", "passw0rd", "password1", "p@ssw0rd",
];
...
pub fn validate(password: &str, config: &PasswordPolicyConfig) -> Vec<String> {
    ...
    if config.disallow_common_passwords && COMMON_PASSWORDS.contains(&password.to_lowercase().as_str())
    {
