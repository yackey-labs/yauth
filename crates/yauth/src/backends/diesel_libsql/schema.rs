//! Diesel table definitions for the libSQL/SQLite backend.
//!
//! Unlike the Postgres backend which uses `Uuid`, `Timestamptz`, `Jsonb`, etc.,
//! the libSQL backend maps everything through SQLite-compatible types:
//! - UUID columns -> `Text` (stored as string)
