//! Diesel-annotated models for the native SQLite backend.
//!
...
/// `QueryableByName` variant of `SqliteUser` for use with `diesel::sql_query()`.
#[derive(Debug, Clone, diesel::QueryableByName)]
pub(crate) struct SqliteUserByName {
...
#[diesel(table_name = yauth_users)]
pub(crate) struct SqliteNewUser {
    pub id: String,
    pub email: String,
    pub display_name: Option<String>,
    pub email_verified: bool,
...
#[diesel(table_name = yauth_users)]
pub(crate) struct SqliteUpdateUser {
...
#[diesel(table_name = yauth_sessions)]
pub(crate) struct SqliteNewSession {
    pub id: String,
    pub user_id: String,
    pub token_hash: String,
    pub ip_address: Option<String>,
...
pub(crate) struct SqliteNewAuditLog {
    pub id: String,
...
#[diesel(check_for_backend(diesel::sqlite::Sqlite))]
pub(crate) struct SqlitePassword {
    pub user_id: String,
...
#[derive(Debug, Clone, Insertable, Serialize, Deserialize)]
#[diesel(table_name = yauth_passwords)]
pub(crate) struct SqliteNewPassword {
    pub user_id: String,
    pub password_hash: String,
}

#[cfg(feature = "email-password")]
impl SqliteNewPassword {
...
#[diesel(check_for_backend(diesel::sqlite::Sqlite))]
pub(crate) struct SqliteEmailVerification {
    pub id: String,
    pub user_id: String,
    pub token_hash: String,
    pub expires_at: String,
...
#[derive(Debug, Clone, Insertable, Serialize, Deserialize)]
#[diesel(table_name = yauth_email_verifications)]
pub(crate) struct SqliteNewEmailVerification {
    pub id: String,
    pub user_id: String,
    pub token_hash: String,
    pub expires_at: String,
...
#[cfg(feature = "email-password")]
impl SqliteNewEmailVerification {
...
#[diesel(check_for_backend(diesel::sqlite::Sqlite))]
pub(crate) struct SqlitePasswordReset {
    pub id: String,
    pub user_id: String,
    pub token_hash: String,
    pub expires_at: String,
...
#[derive(Debug, Clone, Insertable, Serialize, Deserialize)]
#[diesel(table_name = yauth_password_resets)]
pub(crate) struct SqliteNewPasswordReset {
    pub id: String,
    pub user_id: String,
    pub token_hash: String,
    pub expires_at: String,
