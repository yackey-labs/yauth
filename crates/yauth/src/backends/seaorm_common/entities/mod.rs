//! SeaORM entity definitions for all yauth tables.
//!
//! These entities are database-agnostic and shared across all SeaORM backends
//! (PostgreSQL, MySQL, SQLite). Each per-dialect backend re-exports this module.
