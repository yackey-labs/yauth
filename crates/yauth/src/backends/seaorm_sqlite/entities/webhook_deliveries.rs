//! SeaORM entity for `yauth_webhook_deliveries` (SQLite dialect).
...
impl Model {
    pub fn into_domain(self) -> crate::domain::WebhookDelivery {
        crate::domain::WebhookDelivery {
            ...
            webhook_id: crate::backends::seaorm_common::str_to_uuid(&self.webhook_id),
            event_type: self.event_type,
            payload: crate::backends::seaorm_common::str_to_json(&self.payload),
