//! Schema tracking table -- runtime ORM-dependent operations.
//!
//! The pure `schema_hash` function lives in `yauth-migration`.
//! These functions require a diesel connection for runtime tracking.
