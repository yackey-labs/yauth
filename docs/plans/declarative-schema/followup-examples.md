...
2. `examples/e2e_test.rs` — schema reset should use `DieselBackend` migration API, not raw SQL `DROP SCHEMA CASCADE`. Fresh schema setup uses the declarative system.
